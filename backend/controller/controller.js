...
export const postBlog=(req,res,next)=>{
    blogDetails.push({title:req.body.title, content:req.body.content,author:req.body.author})
    res.status(201).json({ message: "Blog created successfully.", blog: blogDetails })
